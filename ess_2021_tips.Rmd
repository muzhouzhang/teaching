...
```{r show na, echo = FALSE, include = FALSE}
...
```{r show fill, echo = FALSE, include = FALSE}
...
```{r show left_join, echo = FALSE, include = FALSE}
...
```{r show right_join, echo = FALSE, include = FALSE}
...
```{r show full_join, echo = FALSE, include = FALSE}
